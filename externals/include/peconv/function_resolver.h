/**
 * @file
 * @brief   Definitions of basic Imports Resolver classes. They can be used for
 * filling imports when the PE is loaded.
 */
...
public:
  /**
  Get the address (VA) of the function with the given name, from the given DLL,
  using LoadLibraryA and GetProcAddress. \param func_name : the name of the
  function \param lib_name : the name of the DLL \return Virtual Address of the
  exported function
  */
