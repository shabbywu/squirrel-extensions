...
typedef enum {
  ...
  LOAD_CONFIG_W10_VER =
      10, /**< Load Config Directory in the Windows 10 version */
...
\return a pointer to the Load Config Directory, NULL if the given PE does not
have this directory
*/
...
*/
t_load_config_ver get_load_config_version(BYTE *buffer, size_t buf_size,
                                          BYTE *ld_config_ptr);
