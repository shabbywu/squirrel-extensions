/**
 * @file
 * @brief   Detecting in which mode is the PE in the supplied buffer (i.e. raw,
 * virtual). Analyzes PE features typical for particular modes.
 */
...
/**
check if Virtual section addresses are identical to Raw addresses (i.e. if the
PE was realigned)
*/
...
*/
bool is_section_expanded(IN const BYTE *pe_buffer, IN size_t pe_size,
