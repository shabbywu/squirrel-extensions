/**
 * @file
 * @brief   Definitions of various versions of Load Config Directory (new fields
 * added with new versions for Windows).
 */
...
/**
IMAGE_LOAD_CONFIG_CODE_INTEGRITY: a structure used by IMAGE_LOAD_CONFIG_DIR -
